...
public class DrawTool extends JPanel {
    ...
    public static void drawPointTriangle (double x, double y)
    {
...
/*	public static void drawPointCircular (double x, double y)
	{
		DrawObject p = new DrawObject ();
		p.color = new Color(Circular.r1, Circular.g1, Circular.b1);
		p.x = x;  p.y = y;
		p.diameter = pointDiameter;
		p.sequenceNum = currentSequenceNum;
		if (animationMode) {
	...
	*/
/*
	public static void drawPointRGB (double x, double y)
	{
		DrawObject p = new DrawObject ();
		p.color = new Color(RGB.r, RGB.g, RGB.b);
		p.x = x;  p.y = y;
		p.diameter = pointDiameter;
		p.sequenceNum = currentSequenceNum;
		if (animationMode) {
...
*/
    ...
    public static void drawSmallLabel (double x, double y, String str)
    {
	Font f = drawArea.getFont ();
	Font f2 = new Font (f.getName(), f.getStyle(), (int) (0.66*f.getSize()));
	drawLabel (x,y, str, f2);
    }

    public static void drawLabel (double x, double y, String str)
    {
	drawLabel (x,y, str, drawArea.getFont());
    }

    public static void drawLabel (double x, double y, String str, Font font)
    {
	DrawObject L = new DrawObject ();
	L.color = labelColor;
	L.x = x;  L.y = y;  
    ...
    public static void setCircleColor (String colorString)
    {
	ovalColor = toColor (colorString, ovalColor);
    }
    ...
    {
	/**** Not fully working, so we'll comment it out.
	...
	*/
	...
	//System.out.println (L.scribbleX);
	...
	g.setColor (Color.black);
        ...
        for (int i=0; i<numIntervals; i++) {
            ...
            //System.out.println (D.height-yTick-inset);
        }
